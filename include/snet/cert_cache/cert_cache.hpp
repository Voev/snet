...
public:
    ...
    bool find(std::string const& key, const crypto::X509CertPtr& expectedOrig, crypto::X509CertPtr& cert,
              crypto::KeyPtr& pkey);
    /// Delete a certificate from database
    bool purgeCert(std::string const& key);
    /// Save certificate to disk.
    bool addCertAndPrivateKey(std::string const& useKey, const crypto::X509CertPtr& cert,
...
private:
    ...
    bool pure_find(std::string const& key, const crypto::X509CertPtr& expectedOrig, crypto::X509CertPtr& cert,
                   crypto::KeyPtr& pkey);
    ...
    static bool WriteEntry(const std::string& filename, const crypto::X509CertPtr& cert,
                           const crypto::KeyPtr& pkey, const crypto::X509CertPtr& orig);

    /// loads a db entry from the file
    static bool ReadEntry(std::string filename, crypto::X509CertPtr& cert, crypto::KeyPtr& pkey,
