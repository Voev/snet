    ...
    namespace cpp
{
    ...
    public:
        ...
        nssv_constexpr14 const_reference at(size_type pos) const
        {
            ...
            if (pos >= size())
            {
                throw std::out_of_range("cpp::string_view::at()");
            }
#endif
            return data_at(pos);
        }
        ...
        size_type copy(CharT* dest, size_type n, size_type pos = 0) const
        {
            ...
            if (pos > size())
            {
                throw std::out_of_range("cpp::string_view::copy()");
            }
#endif
        ...
        nssv_constexpr14 basic_string_view substr(size_type pos = 0, size_type n = npos) const
        {
            ...
            if (pos > size())
            {
                throw std::out_of_range("cpp::string_view::substr()");
            }
#endif
    ...
    private:
        struct not_in_view
        {
            ...
            nssv_constexpr explicit not_in_view(basic_string_view v)
                : v(v)
            {
            }
...
nssv_inline_ns namespace literals
{
    nssv_inline_ns namespace string_view_literals
    {
        ...
        nssv_constexpr cpp::sv_lite::string_view operator"" sv(const char* str, size_t len) nssv_noexcept // (1)
        {
            return cpp::sv_lite::string_view{str, len};
        }

        nssv_constexpr cpp::sv_lite::u16string_view operator"" sv(const char16_t* str, size_t len) nssv_noexcept // (2)
        {
            return cpp::sv_lite::u16string_view{str, len};
        }

        nssv_constexpr cpp::sv_lite::u32string_view operator"" sv(const char32_t* str, size_t len) nssv_noexcept // (3)
        {
            return cpp::sv_lite::u32string_view{str, len};
        }

        nssv_constexpr cpp::sv_lite::wstring_view operator"" sv(const wchar_t* str, size_t len) nssv_noexcept // (4)
        {
            return cpp::sv_lite::wstring_view{str, len};
        }
        ...
        nssv_constexpr cpp::sv_lite::string_view operator"" _sv(const char* str, size_t len) nssv_noexcept // (1)
        {
            return cpp::sv_lite::string_view{str, len};
        }

        nssv_constexpr cpp::sv_lite::u16string_view operator"" _sv(const char16_t* str, size_t len) nssv_noexcept // (2)
        {
            return cpp::sv_lite::u16string_view{str, len};
        }

        nssv_constexpr cpp::sv_lite::u32string_view operator"" _sv(const char32_t* str, size_t len) nssv_noexcept // (3)
        {
            return cpp::sv_lite::u32string_view{str, len};
        }

        nssv_constexpr cpp::sv_lite::wstring_view operator"" _sv(const wchar_t* str, size_t len) nssv_noexcept // (4)
        {
            return cpp::sv_lite::wstring_view{str, len};
        }
...
//
// make types and algorithms available in namespace cpp:
//
...
template <>
struct hash<cpp::string_view>
{
public:
    std::size_t operator()(cpp::string_view v) const nssv_noexcept
    {
...
template <>
struct hash<cpp::wstring_view>
{
public:
    std::size_t operator()(cpp::wstring_view v) const nssv_noexcept
    {
...
template <>
struct hash<cpp::u16string_view>
{
public:
    std::size_t operator()(cpp::u16string_view v) const nssv_noexcept
    {
...
template <>
struct hash<cpp::u32string_view>
{
public:
    std::size_t operator()(cpp::u32string_view v) const nssv_noexcept
    {
