...
/** IP */
#define SNET_ETHERTYPE_IP 0x0800
/** Address resolution */
#define SNET_ETHERTYPE_ARP 0x0806
/** Transparent Ethernet Bridging */
#define SNET_ETHERTYPE_ETHBRIDGE 0x6558
/** Reverse ARP */
#define SNET_ETHERTYPE_REVARP 0x8035
/** AppleTalk protocol */
#define SNET_ETHERTYPE_AT 0x809B
/** AppleTalk ARP */
#define SNET_ETHERTYPE_AARP 0x80F3
/** IEEE 802.1Q VLAN tagging */
#define SNET_ETHERTYPE_VLAN 0x8100
/** IPX */
#define SNET_ETHERTYPE_IPX 0x8137
/** IP protocol version 6 */
#define SNET_ETHERTYPE_IPV6 0x86dd
/** used to test interfaces */
#define SNET_ETHERTYPE_LOOPBACK 0x9000
/** PPPoE discovery */
#define SNET_ETHERTYPE_PPPOED 0x8863
/** PPPoE session */
#define SNET_ETHERTYPE_PPPOES 0x8864
/** MPLS */
#define SNET_ETHERTYPE_MPLS 0x8847
/** Point-to-point protocol (PPP) */
#define SNET_ETHERTYPE_PPP 0x880B
/** RDMA over Converged Ethernet (RoCEv1) */
#define SNET_ETHERTYPE_ROCEV1 0x8915
/** IEEE 802.1ad Provider Bridge, Q-in-Q */
#define SNET_ETHERTYPE_IEEE_802_1AD 0x88A8
/** Wake on LAN */
#define SNET_ETHERTYPE_WAKE_ON_LAN 0x0842
...
public:
    ...
    /**
     * Calculate ether_header#etherType for known protocols: IPv4, IPv6, ARP,
     * VLAN
     */
