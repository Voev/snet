...
public:
    ...
    /**
     * A constructor that allocates a new IPv6 header with source and
    ...
    /**
     * Get a pointer to the IPv6 header. Notice this points directly to the
     ...
     * @return A pointer to the extension instance or nullptr if the requested
     ...
     * @return If the extension is added successfully a pointer to the newly
     * added extension object is returned. Otherwise nullptr is returned
     */
    template <class TIPv6Extension>
