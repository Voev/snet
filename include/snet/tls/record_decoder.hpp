...
public:
    ...
    nonstd::span<std::uint8_t> tls1Decrypt(HashCtx* ctx, std::string_view hmacHash, RecordType rt,
...
private:
    ...
    void ssl3CheckMac(HashCtx* ctx, std::string_view hmacHash, RecordType recordType,
    ...
    /// @param content The content data.
    /// @param mac The MAC to check.
    void tls1CheckMac(std::string_view hmacHash, RecordType recordType, ProtocolVersion version,
